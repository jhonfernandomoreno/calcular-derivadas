...
public class Simpson2 {
    ...
    public String simpson3_8(String funcion1, String a1, String b1, int n1) {
        String mensaje = null;
    ...
    public String errorSimpson3_8(String funcion, String a1, String b1, int n1) {
        String mensaje = null;
        ...
        try {
            ...
            double error;
            error = Math.abs((-0.0375) * (Math.pow(h, 5)) * gamma);
